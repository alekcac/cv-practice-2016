...
int main(int argc, char* argv[])
{
	...
	for (size_t matchInd = 0; matchInd < matches.size(); matchInd++)
	{
		...
		Point orient(int(cos(angle(center - object.pt) + (objectInScene.angle - object.angle) * CV_PI / 180.0) * norm(center - object.pt) * (objectInScene.size / object.size)),
			int(sin(angle(center - object.pt) + (objectInScene.angle - object.angle) * CV_PI / 180.0) * norm(center - object.pt) * (objectInScene.size / object.size)));
